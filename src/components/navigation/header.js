				...
				<div className='flex w-full items-center justify-between'>
					<div className='flex items-center justify-center gap-x-[1.875rem]'>
						<div className='flex gap-x-[0.625rem]'>
							...
							<Link href='https://wa.me/6285608083342'>
								<p className='text-textColor-500 hover:text-secondary-400 dark:text-gray-300 hover:dark:text-secondary-200'>( +62 ) 856 0808 3342</p>
							</Link>
						</div>
						<div className='flex items-center justify-center gap-x-[0.625rem]'>
							...
							<p className='text-textColor-500 dark:text-gray-300'>08 AM - 10 PM</p>
						</div>
					</div>
					...
					<div className='flex items-center justify-center gap-x-[0.625rem]'>
						...
						<Link href='https://maps.app.goo.gl/x6SNN1o82uUfXecGA'>
							<p className='text-textColor-500 hover:text-secondary-400 dark:text-gray-300 hover:dark:text-secondary-200'> Jl. Dharmahusada Indah Barat Block AB 224 Surabaya</p>
						</Link>
					</div>
				</div>
			</div>
